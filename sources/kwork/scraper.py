...
from parsers.browser_manager import WebDriverManager
from sources.kwork.converter import KworkConverter
from sources.kwork.filter import Filter
...
class KworkScraper(Scraper):
    ...
    @staticmethod
    async def _get_filtered_projects(all_projects: list[dict[str, str]]) -> list[dict[str, str]]:
